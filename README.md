...
лише стандартну бібліотеку Python. Після одного запиту лабораторна переходить
до multi-head self-attention і показує, як ваги змінюються для нових токенів.
